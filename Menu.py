...
{Fore.LIGHTGREEN_EX}                                               ░    ░  ░  ░   ░        ░   ░  ░   
    ...
    print(Fore.GREEN +f'                 ╔══════════════════════════════╦══════════════════════════╦══════════════════════════════╗')
    print(Fore.GREEN + '                 ║                              ║                          ║                              ║')
    print(Fore.GREEN +f'                 ║     [{Fore.WHITE}01{Fore.GREEN}] {Fore.WHITE}TOKEN NUKERS        {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}10{Fore.GREEN}] {Fore.WHITE}TOKEN GEN       {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}19{Fore.GREEN}] {Fore.WHITE}TOKEN BRUTE-FORCER  {Fore.GREEN}║')
    print(Fore.GREEN +f'                 ║     [{Fore.WHITE}02{Fore.GREEN}] {Fore.WHITE}TOKEN JOINER        {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}11{Fore.GREEN}] {Fore.WHITE}NITRO GEN       {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}20{Fore.GREEN}] {Fore.WHITE}TOKEN CHECKER       {Fore.GREEN}║')
    ...
    print(Fore.GREEN +f'                 ║     [{Fore.WHITE}05{Fore.GREEN}] {Fore.WHITE}WEBHOOK RAIDER      {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}14{Fore.GREEN}] {Fore.WHITE}QR GRABBER GEN  {Fore.GREEN}║     {Fore.GREEN}[{Fore.WHITE}23{Fore.GREEN}] {Fore.WHITE}PFP CHANGER         {Fore.GREEN}║')
...
░ ▓██▓ ░ ▒██   ██░▓██ █▄  ▒▓█  ▄▓██▒  ▐▌██▒     ▒██░   ▒██   ██░░▓█  ██░░██░▓██▒  ▐▌██▒    
  ...
  def discordserver():
    cls()
    ctypes.windll.kernel32.SetConsoleTitleW("Shrek Multi Tools | Shrek™ Discord Server")
    print(f'''
{Fore.GREEN}
 ▓█████▄   ██  ██████  ▄████▄  ▒█████   ██▀███   ▓█████▄ 
 ▒██▀ ██▌▒▓██▒██    ▒ ▒██▀ ▀█ ▒██▒  ██▒▓██ ▒ ██▒ ▒██▀ ██▌
